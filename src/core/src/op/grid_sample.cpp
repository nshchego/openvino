...
bool op::v9::GridSample::has_evaluate() const {
    return (get_input_element_type(0) == element::f32 || get_input_element_type(0) == element::bf16 || get_input_element_type(0) == element::i32 || get_input_element_type(0) == element::i8) &&
            (get_input_element_type(1) == element::f32 || get_input_element_type(1) == element::bf16);
}
}  // namespace ov
