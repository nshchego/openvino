...
public:
    ...
    void TearDown() override {
        ...
        auto body = subgraph == nullptr ? nullptr : ov::as_type<ngraph::snippets::op::Subgraph>(subgraph)->body_ptr();

        auto subgraph_ref = FunctionHelper::getSubgraph(function_ref);
        auto body_ref = subgraph_ref == nullptr ? nullptr : ov::as_type<ngraph::snippets::op::Subgraph>(subgraph_ref)->body_ptr();
