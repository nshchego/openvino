...
TEST_F(MoveEltwiseUpThroughDataMovTest, SingleUnaryEltwise) {
    ...
    {
        auto input = std::make_shared<ngraph::opset8::Parameter>(ov::element::f32, shape);

        auto transpose_const = ngraph::opset8::Constant::create(ov::element::i64, ngraph::Shape{input_order.size()}, input_order);
        auto transpose = std::make_shared<ngraph::opset8::Transpose>(input, transpose_const);

        auto unsqueeze_const = ngraph::opset8::Constant::create(ov::element::i64, ngraph::Shape{}, {unsqueeze_axis});
...
TEST_F(MoveEltwiseUpThroughDataMovTest, TypeRelaxedEltwise) {
    ...
    const std::vector<int64_t> input_order = {3, 2, 1, 0};
    {
        ...
        auto transpose_const =
            ngraph::opset8::Constant::create(ov::element::i64, ngraph::Shape{input_order.size()}, input_order);
        auto transpose = std::make_shared<ngraph::opset8::Transpose>(intermediate_op, transpose_const);

        auto mul_const = ngraph::opset8::Constant::create(ov::element::f32, {}, {2.f});
...
TEST_F(MoveEltwiseUpThroughDataMovTest, EltwiseSequence) {
    ...
    {
        auto input_left = std::make_shared<ngraph::opset8::Parameter>(ov::element::f32, shape);
        auto input_right = std::make_shared<ngraph::opset8::Parameter>(ov::element::f32, shape);
...
TEST_F(MoveEltwiseUpThroughDataMovTest, SingleBinaryEltwiseWithScalarOnSecondBranch) {
    ...
    const float scalar_value = 0.5f;
    {
        ...
        auto add = std::make_shared<ngraph::opset8::Add>(unsqueeze, ngraph::opset8::Constant::create(ov::element::f32, {}, {scalar_value}));
    ...
    }
    {
        ...
        auto add = std::make_shared<ngraph::opset8::Add>(input, ngraph::opset8::Constant::create(ov::element::f32, {}, {scalar_value}));
...
TEST_F(MoveEltwiseUpThroughDataMovTest, SingleEltwiseWith5ScalarOnSecondBranch) {
    ...
    const float scalar_value = 0.5f;
    {
        ...
        auto add = std::make_shared<ngraph::opset8::Add>(unsqueeze, ngraph::opset8::Constant::create(ov::element::f32, {1, 1, 1, 1, 1}, {scalar_value}));
...
TEST_F(MoveEltwiseUpThroughDataMovTest, SingleBinaryEltwiseWithNotScalarOnSecondBranch) {
    ...
    auto add_scalar = ngraph::opset8::Constant::create(ov::element::f32, {1, 1, 1, 3}, {0.5, 0.2, 0.3});
...
TEST_F(MoveEltwiseUpThroughDataMovTest, SingleUnaryEltwiseDynamicShape) {
    ...
    const int64_t unsqueeze_axis = 2;
    {
        auto input = std::make_shared<ngraph::opset8::Parameter>(ov::element::f32, ngraph::PartialShape::dynamic(3));
...
TEST_F(MoveEltwiseUpThroughDataMovTest, SingleUnaryEltwiseDynamicRank) {
    ...
    auto input = std::make_shared<ngraph::opset8::Parameter>(ov::element::f32, ngraph::PartialShape::dynamic(ngraph::Rank::dynamic()));
