...
TEST_F(MoveEltwiseUpThroughDataMovTest, SingleUnaryEltwise) {
    ...
    const int64_t unsqueeze_axis = 2;
    {
        ...
        auto transpose_const = ov::op::v0::Constant::create(ov::element::i64, ngraph::Shape{input_order.size()}, input_order);
        auto transpose = std::make_shared<ngraph::opset8::Transpose>(input, transpose_const);

        auto unsqueeze_const = ov::op::v0::Constant::create(ov::element::i64, ngraph::Shape{}, {unsqueeze_axis});
...
TEST_F(MoveEltwiseUpThroughDataMovTest, TypeRelaxedEltwise) {
    ...
    const std::vector<int64_t> input_order = {3, 2, 1, 0};
    {
        ...
        auto transpose_const =
            ov::op::v0::Constant::create(ov::element::i64, ngraph::Shape{input_order.size()}, input_order);
...
TEST_F(MoveEltwiseUpThroughDataMovTest, SingleBinaryEltwiseWithScalarOnSecondBranch) {
    ...
    const float scalar_value = 0.5f;
    {
        ...
        auto add = std::make_shared<ngraph::opset8::Add>(unsqueeze, ov::op::v0::Constant::create(ov::element::f32, {}, {scalar_value}));
    ...
    }
    {
        ...
        auto add = std::make_shared<ngraph::opset8::Add>(input, ov::op::v0::Constant::create(ov::element::f32, {}, {scalar_value}));
...
TEST_F(MoveEltwiseUpThroughDataMovTest, SingleEltwiseWith5ScalarOnSecondBranch) {
    ...
    const float scalar_value = 0.5f;
    {
        ...
        auto add = std::make_shared<ngraph::opset8::Add>(unsqueeze, ov::op::v0::Constant::create(ov::element::f32, {1, 1, 1, 1, 1}, {scalar_value}));
...
TEST_F(MoveEltwiseUpThroughDataMovTest, SingleUnaryEltwiseDynamicShape) {
    ...
    const int64_t unsqueeze_axis = 2;
    {
        auto input = std::make_shared<ov::op::v0::Parameter>(ov::element::f32, ngraph::PartialShape::dynamic(3));
...
TEST_F(MoveEltwiseUpThroughDataMovTest, SingleUnaryEltwiseDynamicRank) {
    ...
    auto input = std::make_shared<ov::op::v0::Parameter>(ov::element::f32, ngraph::PartialShape::dynamic(ngraph::Rank::dynamic()));
