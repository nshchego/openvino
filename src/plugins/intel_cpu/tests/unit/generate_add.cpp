...
TEST(SnippetsTests, GenerateAddParams) {
    ...
    auto f = ([] (const ngraph::Shape& shape) -> std::shared_ptr<ngraph::Function>{
        ...
        auto add    = std::make_shared<op::v1::Add>(input0, input1);
...
TEST(SnippetsTests, GenerateAddConstant) {
    ...
    auto f = ([] (const ngraph::Shape& shape) -> std::shared_ptr<ngraph::Function>{
        ...
        auto input1 = std::make_shared<ov::op::v0::Constant>(ov::element::f32, shape, vals);
        auto add    = std::make_shared<op::v1::Add>(input0, input1);
...
TEST(SnippetsTests, GenerateAddConstantScalar) {
    ...
    auto f = ([] (const ngraph::Shape& shape) -> std::shared_ptr<ngraph::Function>{
        auto input0 = std::make_shared<ov::op::v0::Parameter>(ov::element::f32, shape);
        auto input1 = std::make_shared<ov::op::v0::Constant>(ov::element::f32, ngraph::Shape{1}, std::vector<float>({42.f}));
        auto add    = std::make_shared<op::v1::Add>(input0, input1);
...
TEST(SnippetsTests, GenerateAddConstantScalarEmptySize) {
    ...
    auto f = ([] (const ngraph::Shape& shape) -> std::shared_ptr<ngraph::Function>{
        auto input0 = std::make_shared<ov::op::v0::Parameter>(ov::element::f32, shape);
        auto input1 = std::make_shared<ov::op::v0::Constant>(ov::element::f32, ngraph::Shape(), std::vector<float>({42.f}));
        auto add    = std::make_shared<op::v1::Add>(input0, input1);
...
TEST(SnippetsTests, GenerateAddBroadcastX2Edges) {
    ...
    auto f = ([] (const ngraph::Shape& shape0, const ngraph::Shape& shape1) -> std::shared_ptr<ngraph::Function>{
        auto input0 = std::make_shared<ov::op::v0::Parameter>(ov::element::f32, shape0);
        auto input1 = std::make_shared<ov::op::v0::Parameter>(ov::element::f32, shape1);
        auto input2 = std::make_shared<ov::op::v0::Parameter>(ov::element::f32, shape1);

        auto add    = std::make_shared<op::v1::Add>(input0, input1);
        auto mul    = std::make_shared<op::v1::Add>(input1, input2);

        auto sub = std::make_shared<op::v1::Add>(add, mul);

        return std::make_shared<ngraph::Function>(ov::NodeVector{sub}, ngraph::ParameterVector{input0, input1, input2});
    })(shape0, shape1);

    auto s = ([f] (const ngraph::Shape& shape0, const ngraph::Shape& shape1) -> std::shared_ptr<ngraph::Function>{
        auto input2 = std::make_shared<ov::op::v0::Parameter>(ov::element::f32, shape0);
        auto input3 = std::make_shared<ov::op::v0::Parameter>(ov::element::f32, shape1);
        auto input4 = std::make_shared<ov::op::v0::Parameter>(ov::element::f32, shape1);
...
TEST(SnippetsTests, GenerateAddNegate) {
    ...
    auto f = ([] (const ngraph::Shape& shape) -> std::shared_ptr<ngraph::Function>{
        ...
        return std::make_shared<ngraph::Function>(ov::NodeVector{nagate}, ngraph::ParameterVector{input0, input1});
    })(shape);

    auto s = ([f] (const ngraph::Shape& shape) -> std::shared_ptr<ngraph::Function>{
        auto input2 = std::make_shared<ov::op::v0::Parameter>(ov::element::f32, shape);
        auto input3 = std::make_shared<ov::op::v0::Parameter>(ov::element::f32, shape);
...
TEST(SnippetsTests, GenerateAddNegateAdd) {
    ...
    auto input1 = std::make_shared<ov::op::v0::Parameter>(ov::element::f32, shape);
    auto input2 = std::make_shared<ov::op::v0::Parameter>(ov::element::f32, shape);
    auto add = std::make_shared<op::v1::Add>(input1, input2);
    auto nagate = std::make_shared<ngraph::opset1::Negative>(add);
    auto input3 = std::make_shared<ov::op::v0::Parameter>(ov::element::f32, shape);
    auto add2 = std::make_shared<op::v1::Add>(nagate, input3);
    ...
    auto input11 = std::make_shared<ov::op::v0::Parameter>(ov::element::f32, shape);
    auto input21 = std::make_shared<ov::op::v0::Parameter>(ov::element::f32, shape);
    auto input31 = std::make_shared<ov::op::v0::Parameter>(ov::element::f32, shape);
...
TEST(SnippetsTests, GenerateAddNegateAddMultiEdge) {
    ...
    auto add    = std::make_shared<op::v1::Add>(input1, input2);
    auto nagate = std::make_shared<ngraph::opset1::Negative>(add);
    auto add2 = std::make_shared<op::v1::Add>(nagate, input1);
    std::shared_ptr<ngraph::Function> f = std::make_shared<ngraph::Function>(ov::NodeVector{add2}, ngraph::ParameterVector{input1, input2});
...
TEST(SnippetsTests, GenerateAddBroadcastAutomatic) {
    ...
    auto f = ([] (const ngraph::Shape& shape0, const ngraph::Shape& shape1, const ngraph::Shape& shape2) -> std::shared_ptr<ngraph::Function>{
        auto input0 = std::make_shared<ov::op::v0::Parameter>(ov::element::f32, shape0);
        auto input1 = std::make_shared<ov::op::v0::Parameter>(ov::element::f32, shape1);
        auto input2 = std::make_shared<ov::op::v0::Parameter>(ov::element::f32, shape2);

        auto add = std::make_shared<op::v1::Add>(input0, input1);
        auto mul = std::make_shared<op::v1::Multiply>(input1, input2);
        auto sub = std::make_shared<op::v1::Subtract>(add, mul);
