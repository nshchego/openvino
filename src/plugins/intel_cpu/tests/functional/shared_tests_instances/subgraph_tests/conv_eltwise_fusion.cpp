...
namespace {
    ...
    INSTANTIATE_TEST_SUITE_P(smoke_Convolution_1D, ConvEltwiseFusion,
                            ::testing::Combine(
                                    ::testing::Values(std::tuple<ov::NodeTypeInfo, size_t>{ov::op::v1::Convolution::get_type_info_static(), 2}),
    ...
    INSTANTIATE_TEST_SUITE_P(smoke_GroupConvolution_1D, ConvEltwiseFusion,
                            ::testing::Combine(
                                    ::testing::Values(std::tuple<ov::NodeTypeInfo, size_t>{ov::op::v1::GroupConvolution::get_type_info_static(), 2}),
                                    ::testing::ValuesIn(eltwise_types),
                                    ::testing::Values(false),
    ...
    INSTANTIATE_TEST_SUITE_P(smoke_ConvolutionBackpropData_1D, ConvEltwiseFusion,
                            ::testing::Combine(
                                    ::testing::Combine(
                                        ::testing::Values(ov::op::v1::ConvolutionBackpropData::get_type_info_static()),
    ...
    INSTANTIATE_TEST_SUITE_P(smoke_GroupConvolutionBackpropData_1D, ConvEltwiseFusion,
                            ::testing::Combine(
                                    ::testing::Combine(
                                        ::testing::Values(ov::op::v1::GroupConvolutionBackpropData::get_type_info_static()),
                                        ::testing::ValuesIn(std::vector<size_t>{2, 3})),
                                    ::testing::ValuesIn(eltwise_types),
                                    ::testing::Values(false),
                                    ::testing::Values(ov::Shape{1, 12, 64}),
    ...
    INSTANTIATE_TEST_SUITE_P(smoke_GroupConvolution_2D_Negative, ConvEltwiseFusion,
                            ::testing::Combine(
                                    ::testing::Values(
                                        std::tuple<ov::NodeTypeInfo, size_t>{ov::op::v1::GroupConvolution::get_type_info_static(), 2}),
                                    ::testing::ValuesIn(eltwise_types),
                                    ::testing::Values(true),
    ...
    INSTANTIATE_TEST_SUITE_P(smoke_ConvolutionBackpropData_2D_Negative, ConvEltwiseFusion,
                            ::testing::Combine(
                                    ::testing::Values(
                                        std::tuple<ov::NodeTypeInfo, size_t>{ov::op::v1::ConvolutionBackpropData::get_type_info_static(), 2}),
                                    ::testing::ValuesIn(eltwise_types),
                                    ::testing::Values(true),
                                    ::testing::Values(ov::Shape{1, 12, 3, 3}),
    ...
    INSTANTIATE_TEST_SUITE_P(smoke_GroupConvolutionBackpropData_2D_Negative, ConvEltwiseFusion,
                            ::testing::Combine(
                                    ::testing::Values(
                                        std::tuple<ov::NodeTypeInfo, size_t>{ov::op::v1::GroupConvolutionBackpropData::get_type_info_static(), 2}),
                                    ::testing::ValuesIn(eltwise_types),
                                    ::testing::Values(true),
                                    ::testing::Values(ov::Shape{1, 12, 3, 3}),
                                    ::testing::Values(ov::Shape{4, 3, 5, 1, 1}),
