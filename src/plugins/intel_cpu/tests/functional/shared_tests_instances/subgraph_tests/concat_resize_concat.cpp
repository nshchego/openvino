...
protected:
    void SetUp() override {
        ...
        auto inputNode1 = std::make_shared<ngraph::opset4::Parameter>(ov::element::f32, ov::Shape(shape1));
        auto inputNode2 = std::make_shared<ngraph::opset4::Parameter>(ov::element::f32, ov::Shape(shape1));
        auto inputNode3 = std::make_shared<ngraph::opset4::Parameter>(ov::element::f32, ov::Shape(shape2));
        // concat layer
