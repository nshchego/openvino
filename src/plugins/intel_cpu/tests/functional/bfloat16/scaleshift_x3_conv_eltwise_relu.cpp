...
protected:
    std::shared_ptr<ov::Model> createGraph(InferenceEngine::Precision netPrecision) override {
        ...
        // multiply
        std::shared_ptr<ov::op::v0::Constant> const3 = nullptr;
        if (netPrecision == Precision::FP32) {
        ...
        // add
        std::shared_ptr<ov::op::v0::Constant> const4 = nullptr;
        if (netPrecision == Precision::FP32) {
        ...
        // multiply
        std::shared_ptr<ov::op::v0::Constant> const5 = nullptr;
        if (netPrecision == Precision::FP32) {
        ...
        // add
        std::shared_ptr<ov::op::v0::Constant> const6 = nullptr;
        if (netPrecision == Precision::FP32) {
        ...
        return std::make_shared<ov::Model>(ov::NodeVector{addNode3}, ov::ParameterVector{input1});
    }
