...
protected:
    std::shared_ptr<ov::Model> createGraph(InferenceEngine::Precision netPrecision) override {
        ...
        ov::Shape convFilterShape2 = { channelsCount, 1, 1, 3, 3 };
        if (netPrecision == Precision::FP32) {
        ...
        std::shared_ptr<ov::Node> convNode2 = std::make_shared<ov::op::v1::GroupConvolution>(
        ...
        return std::make_shared<ov::Model>(reluNode2, ov::ParameterVector{input1});
    }
    void SetUp() override {
