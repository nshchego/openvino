...
public:
    ...
    void SetUp() override {
        ...
        auto transposeOrder = ngraph::opset8::Constant::create(ov::element::i32, {4}, {0, 3, 2, 1});
        auto transpose = std::make_shared<ngraph::opset8::Transpose>(inputParams[0], transposeOrder);

        auto concatConstantInput = ngraph::opset8::Constant::create(ov::element::f32, {1, 1, 3, 3}, {10.0f});
