...
void Config::applyRtInfo(BinaryInputBuffer& in_buf) {
    // in_buf >> this->kvCachePrecision;
    in_buf >> this->keyCacheGroupSize;
    // in_buf >> this->keyCachePrecision;
    in_buf >> this->valueCacheGroupSize;
    // in_buf >> this->valueCachePrecision;
    in_buf >> this->fcDynamicQuantizationGroupSize;
}
