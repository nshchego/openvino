...
ov::intel_cpu::ConvertMatMulToFC::ConvertMatMulToFC() {
    ...
    ngraph::matcher_pass_callback callback = [=](ngraph::pattern::Matcher& m) {
        ...
        auto create_transpose = [this, &new_ops ](const ngraph::Output<ov::Node>& node, const std::string& transpose_name) {
            ...
            auto transpose_const = ngraph::opset1::Constant::create(ov::element::i64, ngraph::Shape{ transpose_order.size() }, transpose_order);
        ...
        if (rank_b != 2) {
            ...
            auto reshape_shape = ngraph::opset1::Constant::create(ov::element::i64, ngraph::Shape{ 2 }, reshape_shape_values);
