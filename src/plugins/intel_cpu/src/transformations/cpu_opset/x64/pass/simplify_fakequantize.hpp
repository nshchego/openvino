...
inline std::vector<float> simplifyToScale(const std::shared_ptr<op::v0::FakeQuantize>& fq_node,
                                   float threshold = 0.0001f) {
    auto levels = fq_node->get_levels();
    auto input_low = ov::as_type_ptr<op::v0::Constant>(fq_node->get_input_node_shared_ptr(1))->cast_vector<float>();
    auto input_high =
        ov::as_type_ptr<op::v0::Constant>(fq_node->get_input_node_shared_ptr(2))->cast_vector<float>();
    auto output_low =
        ov::as_type_ptr<op::v0::Constant>(fq_node->get_input_node_shared_ptr(3))->cast_vector<float>();
    auto output_high =
        ov::as_type_ptr<op::v0::Constant>(fq_node->get_input_node_shared_ptr(4))->cast_vector<float>();
