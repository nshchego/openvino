...
//        uint64_t gridBatchStepB = 0lu;
        float srcHeightMul2Fl = 1.f;
        float srcWidthMul2Fl = 1.f;
        float srcHeightMul2Sub1Fl = 1.f;
        float srcWidthMul2Sub1Fl = 1.f;
        float srcHeightSub1Fl = 0.f;
        float srcWidthSub1Fl = 0.f;
