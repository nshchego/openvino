...
void CTCLoss::save(BinaryOutputBuffer& out_buf) const {
    Node::save(out_buf);

    out_buf.dump_position();  // TODO: remove

    out_buf << ctcMergeRepeated;
    out_buf << preprocessCollapseRepeated;
    out_buf << unique;

    out_buf.dump_position();  // TODO: remove
}

void CTCLoss::load(BinaryInputBuffer& in_buf) {
    in_buf.check_position();  // TODO: remove

    in_buf >> ctcMergeRepeated;
    in_buf >> preprocessCollapseRepeated;
    in_buf >> unique;
