...
static void TransformationUpToCPUSpecificOpSet(std::shared_ptr<ngraph::Function> nGraphFunc, const bool _enableLPT, const bool _enableBF16,
    ...
    if (useLpt) {
        ...
        manager.register_pass<ov::pass::DisableConvertConstantFoldingOnConstPath>(defaultPrecisions);
    }
    ...
    manager.register_pass<ov::pass::ConvertTensorIteratorToSequence>();
    ...
    pass_config->set_callback<ov::pass::ConvertTensorIteratorToRNNSequence,
    ...
    if (useLpt) {
        ...
        pass_config->set_callback<ov::pass::ConvertSubtract>([&defaultPrecisions](const_node_ptr &node) -> bool {
