...
std::string GatherElLayerTest::getTestCaseName(const testing::TestParamInfo<GatherElParams>& obj) {
...
TEST_P(GatherElLayerTest, CompareWithRefs) {
    Run();
}
}  // namespace LayerTestsDefinitions
