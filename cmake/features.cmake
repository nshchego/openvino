...
# set(ENABLE_INTEL_OPENMP ON)
message("DEBUG THREADING: ${THREADING}")
message("DEBUG ENABLE_INTEL_OPENMP: ${ENABLE_INTEL_OPENMP}")
message("DEBUG ENABLE_INTEL_OPENMP_DEFAULT: ${ENABLE_INTEL_OPENMP_DEFAULT}")

# ov_dependent_option (ENABLE_INTEL_OPENMP "Enables usage of Intel OpenMP instead of default compiler one" ${ENABLE_INTEL_OPENMP_DEFAULT} "THREADING STREQUAL SEQ" ON)
ov_option (ENABLE_INTEL_OPENMP "EEnables usage of Intel OpenMP" ON)
